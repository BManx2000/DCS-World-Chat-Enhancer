...
base.print("----function createChat------")
 ...
 --   vsScroll:setThumbValue(1)
  ...
  --  vsScroll:setPageStep(1)
    ...
    testStatic:setBounds(0,0,widthChat,30)
...
function resize(w, h)
    window:setBounds(chatPos.x, chatPos.y, 533, 674+195)
    
    btnMail:setBounds(12, 0, 36, 81)
    box:setBounds(0, 0, 533, 674+195)
    
    pQuery:setBounds(0, 519, 360, 195)
end
...
function resizeEditMessage()
    ...
    box:setBounds(x,0,w,eMy+newH+470+195)
    pQuery:setBounds(0, eMy+newH+470, 360, 195)
   ...
   window:setSize(w,eMy+newH+551+195)
end
