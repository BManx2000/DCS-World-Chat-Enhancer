...
function resize(w, h)
    window:setBounds(chatPos.x, chatPos.y, 360, 455+195)
    
    btnMail:setBounds(12, 0, 24, 55)
    box:setBounds(0, 0, 360, 400+195)
    
    pQuery:setBounds(0, 380, 360, 195)
end
...
function resizeEditMessage()
    ...
    box:setBounds(x,0,w,eMy+newH+317+195)
    pQuery:setBounds(0, eMy+newH+317, 360, 195)
   ...
   window:setSize(w,eMy+newH+317+55+195)
end
