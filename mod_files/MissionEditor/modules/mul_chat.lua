...
function resize(w, h)
    window:setBounds(0, h/2-296, 533, 674)
    
    btnMail:setBounds(12, 0, 36, 81)
    box:setBounds(0, 55, 533, 593)
end
...
function setMode(a_mode)
    ...
    if modeCur == "min" then
        ...
        window:setBounds(0, h/2-296, 53, 81)
        btnMail:setBounds(12, 0, 36, 81)
    end
